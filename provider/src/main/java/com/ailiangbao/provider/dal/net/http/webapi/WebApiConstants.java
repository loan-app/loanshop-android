...
public final class WebApiConstants {
    ...
    //线上测试服47.111.165.27
    private static final String HOST_STUFF = ProviderApplication.getInstance().isTestServer() ? "35.241.105.201:8081/ycqb-api" : "api.jbhunt.cc/ycqb-api";
    ...
    public static String getITGHost() {
        return ProviderApplication.getInstance().isTestServer() ? "35.241.105.201:8081/ycqb-api" : "api.jbhunt.cc/ycqb-api";
    }

package com.ailiangbao.provider.dal.util.collection;
...
public final class CollectionPicker {
    ...
    @Nullable
    public static <E, T, TS> List<XPair<Integer, TS>> _pickPairsCast(@Nullable E expect, Class<TS> castClass, @Nullable Collection<T> collection, @NonNull PickerController<E, TS> pickerController) {
        if (null == expect || CollectionUtil.isEmpty(collection)) {
            return null;
        }
